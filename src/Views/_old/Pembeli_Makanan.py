...
class MenuMakanan(QWidget):
    def __init__(self):
        super(MenuMakanan, self).__init__()
    ...
    def rightSide(self):
        ...
        self.labelPesan = QLabel("Nasi uduk", self.centralWidget)
        ...
        self.labelPesan1 = QLabel("Nasi uduk", self.centralWidget)
        ...
        self.labelPesan2 = QLabel("Nasi uduk", self.centralWidget)
        ...
        self.labelPesan3 = QLabel("Nasi uduk", self.centralWidget)
...
#grid2
        ...
        self.labelPesan5 = QLabel("Nasi uduk", self.centralWidget)
        ...
        self.labelPesan6 = QLabel("Nasi uduk", self.centralWidget)
        ...
        self.labelPesan7 = QLabel("Nasi uduk", self.centralWidget)
